...
<ul class="nav nav-tabs">
    <li class="active"><a href="##">团队手续费计算</a></li>
</ul>
<form:form id="searchForm" modelAttribute="userAccountchange"
           action="${ctx}/user/hclmReport/sumChargeByTeam/" method="post"
...
<div class="bochu">
    <ul>
        <li>
            <div>
                <div>
                    <span>团队总手续费:</span>&nbsp;<span>${money}</span>
                </div>
                <p>当前领导人团队所有用户手续费总和</p>
            </div>
        </li>
        <%--<li>--%>
            <%--<div>--%>
                <%--<div>--%>
                    <%--<span>矿机钱包总额:</span>&nbsp;<span>${hclmReport.dividendTwo==null ? '--' : hclmReport.dividendTwo}</span>--%>
                <%--</div>--%>
