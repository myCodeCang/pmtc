...
<body>
	...
	<form:form id="searchForm" modelAttribute="userUserinfo" action="${ctx}/user/userUserinfo/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			<li><label>账号：</label>
				<form:input path="userName" htmlEscape="false" maxlength="255" class="input-medium" style="width:125px;"/>
			</li>
			<li><label>手机号：</label>
				<form:input path="mobile" htmlEscape="false" maxlength="50" class="input-medium" style="width:125px;"/>
			</li>
			<li><label>真实姓名：</label>
				<form:input path="trueName" htmlEscape="false" maxlength="50" class="input-medium" style="width:125px;"/>
			</li>
			<li><label>钱包地址:</label>
				<form:input path="remarks" htmlEscape="false" maxlength="50" class="input-medium" style="width:125px;"/>
			</li>
			<%--<li><label>归属机构：</label>--%>
			...
			<li><label>推荐人账号：</label>
				<form:input path="parentName" htmlEscape="false" maxlength="50" class="input-medium" style="width:125px;"/>
			</li>
			<li><label>领导人：</label>
				<input type="text" value="${leader}" name="leader" htmlEscape="false" maxlength="50" class="input-medium" style="width:120px;"/>
			</li>
			<li><label>注册时间：</label>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="userUserinfo">
			<tr>
				...
				<%--</td>--%>
				<td>
						${fns:getDictLabel(userUserinfo.shopId, 'user_status', '')}
				...
				<shiro:hasPermission name="user:userUserinfo:edit"><td>
					...
					<a href="${ctx}/user/userUserinfoExPmtc/changeUserParent?userName=${userUserinfo.userName}" style="display:inline-block;float: left;" class="layui-btn layui-btn-mini layui-btn-normal">修改上级</a>
