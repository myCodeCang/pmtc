...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/user/userLevel/">团队等级列表</a></li>

		<%--<li>--%>
			<%--<sys:qyframe id="addLevel" url="${ctx}/user/userLevel/form" width="500" height="500" title="添加等级"></sys:qyframe>--%>
		<%--</li>--%>
		<shiro:hasPermission name="user:userLevel:edit"><li><a href="${ctx}/user/userLevel/form">团队等级添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="userLevel">
			<tr>
				...
				<shiro:hasPermission name="user:userLevel:edit"><td>
					...
					<a href="${ctx}/user/userLevel/delete?id=${userLevel.id}" onclick="return confirmx('确认要删除该团队等级吗？', this.href)" class="layui-btn layui-btn-mini layui-btn-normal">删除</a>
