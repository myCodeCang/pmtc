...
<body>
	...
	<form:form id="inputForm" modelAttribute="userUserinfo" action="${ctx}/user/userUserinfo/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">增量等级：</label>
			<div class="controls">
				<form:input path="mainPerformance" htmlEscape="false" maxlength="50" class="input-xlarge " type="number" />
				<span class="help-inline"><font color="red">*(输入要提升的等级数)</font></span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">用户等级:</label>
			<div class="controls">
				<input value="${userUserinfo.areaId}" readonly htmlEscape="false" maxlength="60" class="input-xlarge " type="text"/>
				<span class="help-inline"><font color="red">*</font></span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">团队等级:</label>
			<div class="controls">
				<input value="${userUserinfo.userLevel.levelName}" readonly htmlEscape="false" maxlength="60" class="input-xlarge " type="text"/>
				<span class="help-inline"><font color="red">*</font></span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="remarks" htmlEscape="false" readonly="true" maxlength="50" class="input-xlarge "/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		...
		<div class="control-group">
			<label class="control-label">转账短信验证：</label>
			<div class="controls">
				<form:select path="isShop">
					<form:options items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
