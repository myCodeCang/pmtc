...
<link rel="stylesheet" href="${ctxStatic}/qysoftui/css/system/settings/display.css">
<link rel="stylesheet" href="${ctxStatic}/qysoftui/fonts/material-design/material-design.css">
<link rel="stylesheet" href="${ctxStatic}/qysoftui/vendor/bootstrap-select/bootstrap-select.css">
<link rel="stylesheet" href="${ctxStatic}/qysoftui/vendor/switchery/switchery.css">
    ...
    <div class="page-content">
        <form id="displayForm" class="form-horizontal padding-vertical-30">
            <div class="form-group">
                ...
                <div class="col-sm-10" id="skintoolsNavbar">
                    <ul class="list-unstyled list-inline color-radio">
                        <li>
                            <div class="radio-custom radio-primary">
                                <input type="radio" checked="checked" name="navigationColor" value="">
                                <label></label>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            <div class="radio-custom radio-red">
                                <input type="radio" name="navigationColor" value="rebg-red-600">
                                <label></label>
                            </div>
                        </li>
                        <li>
                    ...
                    <div class="checkbox-custom checkbox-primary margin-top-10">
                        <input type="checkbox" checked="checked" id="navbarDisplay" name="acrossFlag" value="navbar-inverse">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select id="skintoolsSidebar" name="menuTheme">
                    ...
                    <div class="margin-top-10 hidden" id="menuFoldSetting">
                        ...
                        <div class="btn-group btn-group-xs" data-toggle="buttons">
                            <label class="btn  btn-outline btn-dark active" for="textIconKeep">
                                <input type="radio" id="textIconKeep" autocomplete="off" hidden="hidden" checked="checked" name="menuTxtIcon" value="site-menubar-keep">
                                文字
                            </label>
                            <label class="btn btn-outline btn-dark" for="textIconAlt">
                                <input type="radio" id="textIconAlt" autocomplete="off" hidden="hidden" name="menuTxtIcon" value="site-menubar-fold-alt">
                                图标
                            </label>
                        </div>
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10" id="skintoolsPrimary">
                    <ul class="list-unstyled list-inline color-radio">
                        <li>
                            <div class="radio-custom radio-primary">
                                <input type="radio" checked name="themeColor" value="primary">
                                <label></label>
                            </div>
                        </li>
                        <li>
            ...
            <div class="form-group">
                <div class="col-sm-10 col-sm-offset-2 margin-top-20">
                    ...
                    <button type="button" class="btn btn-outline btn-default" name="reset" value="reset" id="skintoolsReset">
                        恢复默认
                    </button>
                </div>
            </div>
...
<script src="${ctxStatic}/qysoftui/vendor/switchery/switchery.min.js"></script>
<script src="${ctxStatic}/qysoftui/vendor/bootstrap-select/bootstrap-select.min.js" data-name="select"></script>
<script src="${ctxStatic}/qysoftui/js/system/settings/display.js" data-deps="select"></script>
