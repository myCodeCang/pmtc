...
<div class="page animation-fade page-forms">
    <div class="page-content">
        <div class="page-header">
            <h1 class="page-title title_h1">接点会员列表</h1>
        ...
        window.Content = {
            ...
            initTable: function () {
                    ...
                    "columnDefs": [
                       {
                            "targets": 10,
                            "data": null,
                            "defaultContent": '<button  id="searchTBtn" class="searchTBtn btn btn-outline btn-sm btn-primary" >查看下级</button>'
                        },
                        {
                ...
                $content.on('click', '#searchTBtn', function () {
                    ...
                    $.pjax({
                        url: "${ctx}/user/userJDList?userName="+data.userName,
