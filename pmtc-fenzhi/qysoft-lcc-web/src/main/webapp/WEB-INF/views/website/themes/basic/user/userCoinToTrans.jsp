                ...
                <div class="row row-lg">
                    <div class="col-sm-12 col-md-9">
                        <div class="example-wrap">
                            <h4 class="example-title title_h4">总钱包外部转账</h4>
                            <div class="example message_group">
                                <form class="form-horizontal" id="userInfo" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">外网钱包地址:</label>
                                        <span class="col-sm-3">
                                            <input type="text"  id="address" name="address" style="border:1px solid #ccc;border-radius:4px;padding-left:10px;">
                                        </span>
                                    </div>
                                    <%--<div class="form-group">--%>
                                    ...
                                    <div class="form-group" style="display: ${userinfo.isShop != '0'?'block':'none'}">
                                        ...
                                        <span class="col-sm-3" style="float: left;">
                                            <div class="input-group">
                                                ...
                                                <span style="display:inline-block;cursor: pointer;float: right;width:35%;background-color: #f3f7f9;border: 1px solid #ccc;height:34px;line-height:34px;border-radius:4px;text-align: center;" id="getCountStart">获取</span>
                                            </div>
                                        </span>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <span class="col-sm-3">
                                            <textarea style="height:100px;width:94%;border:1px solid #ddd;border-radius: 3px;" name="message"></textarea>
                                        </span>
                                    </div>
                                    <div class="form-group">
...
<script type="text/javascript" data-deps="formValidation">
    ...
    (function (document, window, $) {
        ...
        $('#getCountStart').on('click', function() {
            getStartCode();
        });
        ...
        window.Content = {
            ...
            initFormValidate : function(){
                ...
                $('#userInfo').formValidation().on('success.form.fv', function (e) {
                    ...
                    $.app.ajax($.ctx + 'userCoinToTrans', $("#userInfo").serialize(), function (data) {
                        $.pjax({
    ...
    function doLoop() {
        ...
        if (cont > 0) {
            ...
            clearInterval(clock);
            //清除js定时器
            $("#getCountStart").removeAttr("disabled");
            $("#getCountStart").text('获取');
            cont = 60;
            //重置时间
