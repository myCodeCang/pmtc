...
public class OaNotifyController extends BaseController {
	...
	public String form(OaNotify oaNotify, Model model) {
		if (StringUtils2.isNotBlank(oaNotify.getId())){
	...
	public String save(OaNotify oaNotify, Model model, RedirectAttributes redirectAttributes) throws ValidationException {
	...
	public String delete(OaNotify oaNotify, RedirectAttributes redirectAttributes) throws ValidationException{
