...
//		view += ".jsp";
	...
	public String index(HttpServletRequest request, HttpServletResponse response) {
		Principal principal = UserUtils.getPrincipal();
		PrincipalCollection coll =  UserUtils.getSubject().getPrincipals(); 
...
//		// 登录成功后，获取上次登录的当前站点ID
//		UserUtils.putCache("siteId", StringUtils2.toLong(CookieUtils.getCookie(request, "siteId")));

//		System.out.println("==========================a");
//		try {
//			byte[] bytes = com.thinkgem.jeesite.common.utils.FileUtils2.readFileToByteArray(
//					com.thinkgem.jeesite.common.utils.FileUtils2.getFile("c:\\sxt.dmp"));
...
//		System.out.println("==========================b");
	...
	public String getThemeInCookie(@PathVariable String theme, HttpServletRequest request, HttpServletResponse response){
		if (StringUtils2.isNotBlank(theme)){
