...
public class GuestbookController extends BaseController {
	...
	@RecordLog(logTitle = "内容管理-公共留言-新增/修改")
	@RequiresPermissions("cms:guestbook:edit")
	@RequestMapping(value = "save")
	public String save(Guestbook guestbook, Model model, RedirectAttributes redirectAttributes) throws ValidationException {
	...
	@RecordLog(logTitle = "内容管理-公共留言-删除")
	@RequiresPermissions("cms:guestbook:edit")
