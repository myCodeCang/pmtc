...
public class CategoryController extends BaseController {
	...
	@RecordLog(logTitle = "内容管理-栏目管理-栏目添加-新增/修改")
	@RequiresPermissions("cms:category:edit")
	@RequestMapping(value = "save")
	public String save(Category category, Model model, RedirectAttributes redirectAttributes) throws ValidationException {
	...
	@RecordLog(logTitle = "内容管理-栏目管理-栏目删除")
	@RequiresPermissions("cms:category:edit")
	@RequestMapping(value = "delete")
	public String delete(Category category, RedirectAttributes redirectAttributes)throws ValidationException {
		if(Global.isDemoMode()){
			addMessage(redirectAttributes, "演示模式，不允许操作！");
			return "redirect:" + adminPath + "/cms/category/";
		}
	 ...
	 * 批量修改栏目排序
	 */
	@RecordLog(logTitle = "内容管理-栏目管理-保存排序")
	@RequiresPermissions("cms:category:edit")
	@RequestMapping(value = "updateSort")
	public String updateSort(String[] ids, Integer[] sorts, RedirectAttributes redirectAttributes) throws ValidationException {
    	int len = ids.length;
