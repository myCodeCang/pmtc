...
public class RoleController extends BaseController {
	...
	@RecordLog(logTitle = "系统设置-角色管理-角色添加-新增/修改")
	@RequiresPermissions("sys:role:edit")
	@RequestMapping(value = "save")
	public String save(Role role, Model model, RedirectAttributes redirectAttributes) throws ValidationException {
	...
	@RecordLog(logTitle = "系统设置-角色管理-角色删除")
	@RequiresPermissions("sys:role:edit")
...
//		}
	 ...
	 * @return
	 */
	@RecordLog(logTitle = "系统设置-角色管理-角色移除")
	@RequiresPermissions("sys:role:edit")
	@RequestMapping(value = "outrole")
	public String outrole(String userId, String roleId, RedirectAttributes redirectAttributes) throws ValidationException {
		if(Global.isDemoMode()){
			addMessage(redirectAttributes, "演示模式，不允许操作！");
	 ...
	 * @return
	 */
	@RecordLog(logTitle = "系统设置-角色管理-角色分配")
	@RequiresPermissions("sys:role:edit")
	@RequestMapping(value = "assignrole")
	public String assignRole(Role role, String[] idsArr, RedirectAttributes redirectAttributes) throws ValidationException {
		if(Global.isDemoMode()){
			addMessage(redirectAttributes, "演示模式，不允许操作！");
			return "redirect:" + adminPath + "/sys/role/assign?id="+role.getId();
		}
