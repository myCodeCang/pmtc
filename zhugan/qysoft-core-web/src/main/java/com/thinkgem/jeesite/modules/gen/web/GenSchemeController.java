...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils2.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.thinkgem.jeesite.modules");
		}
//		if (StringUtils2.isBlank(genScheme.getFunctionAuthor())){
...
//		}
	...
	@RecordLog(logTitle = "代码生成-生成方案配置-生成方案添加-新增/修改")
	@RequiresPermissions("gen:genScheme:edit")
	@RequestMapping(value = "save")
	public String save(GenScheme genScheme, Model model, RedirectAttributes redirectAttributes) throws ValidationException {
	...
	@RecordLog(logTitle = "代码生成-生成方案配置-生成方案删除")
	@RequiresPermissions("gen:genScheme:edit")
