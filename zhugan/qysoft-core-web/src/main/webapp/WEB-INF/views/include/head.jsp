...
<link href="${ctxStatic}/layerUI/css/layui.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/layerUI/layui.js" type="text/javascript"></script>
<script type="text/javascript">var ctx = '${ctx}', ctxStatic='${ctxStatic}';</script>

<script type="text/javascript">
	//加载layUI自定义模块
	layui.config({
		base : '${ctxStatic}/common/qyLayerModule/' //假设这是test.js所在的目录
	}).extend({ //设定模块别名
