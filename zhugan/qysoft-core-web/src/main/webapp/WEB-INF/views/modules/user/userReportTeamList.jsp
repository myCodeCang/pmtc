...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="##">团队资产报表</a></li>
	...
	<form:form id="searchForm" modelAttribute="userReport"
		action="${ctx}/user/userReport/teamList" method="post"
		class="breadcrumb form-search">
		<input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}" />
		<input id="pageSize" name="pageSize" type="hidden"
			value="${page.pageSize}" />
		<ul class="ul-form">
			<li><label>用户名：</label><sys:userinfoSelect id="userName" value="${userReport.userName}" title="用户选择" cssClass="" />
			</li>
			<li><label>月份: </label>
	...
	<form:form id="inputForm" modelAttribute="team" action="" method="post" class="form-horizontal">
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">用户名称：</label>
			<div class="controls">
				<form:input path="userUserinfo.userName" htmlEscape="false" maxlength="255" class="input-xlarge" readonly="true" />
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="userUserinfo.trueName" htmlEscape="false" maxlength="255" class="input-xlarge" readonly="true" />
