...
public class TestAuditService extends CrudService<TestAuditDao, TestAudit> {
	...
	public void save(TestAudit testAudit) throws ValidationException {
		
		// 申请发起
		if (StringUtils2.isBlank(testAudit.getId())){
			testAudit.preInsert();
	 ...
	 */
	@Transactional(readOnly = false)
	public void auditSave(TestAudit testAudit) throws ValidationException {
