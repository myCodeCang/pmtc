...
//		if (StringUtils2.isNotBlank(comment.getContentId())){
//			dc.add(Restrictions.eq("contentId", comment.getContentId()));
//		}
//		if (StringUtils2.isNotEmpty(comment.getTitle())){
...
//		return commentDao.find(page, dc);
	...
	public void delete(Comment entity, Boolean isRe)throws ValidationException {
		super.delete(entity);
	}
}
