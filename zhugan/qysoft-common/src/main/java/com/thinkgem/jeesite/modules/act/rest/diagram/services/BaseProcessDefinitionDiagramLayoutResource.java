	...
	private void getActivity(String processInstanceId, ActivityImpl activity, ArrayNode activityArray, ArrayNode sequenceFlowArray,
		...
		for (Map.Entry<String, Object> entry : properties.entrySet()) {
			...
			if (prop instanceof String)
				propertiesJSON.put(key, (String) entry.getValue());
			else if (prop instanceof Integer)
				propertiesJSON.put(key, (Integer) entry.getValue());
			else if (prop instanceof Boolean)
				propertiesJSON.put(key, (Boolean) entry.getValue());
			else if ("initial".equals(key)) {
				ActivityImpl act = (ActivityImpl) entry.getValue();
				...
				ArrayList<EventSubscriptionDeclaration> eventDefinitions = (ArrayList<EventSubscriptionDeclaration>) entry.getValue();
				...
				ArrayList<ErrorEventDefinition> errorEventDefinitions = (ArrayList<ErrorEventDefinition>) entry.getValue();
