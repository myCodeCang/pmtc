...
//		if (StringUtils2.isNotEmpty(site.getName())){
...
//		return siteDao.find(page, dc);
	...
	public void save(Site site) throws ValidationException {
	...
	@Transactional(readOnly = false)
	public void delete(Site site, Boolean isRe) throws ValidationException{
