...
//		if (category.getSite()!=null && StringUtils2.isNotBlank(category.getSite().getId())){
//			dc.createAlias("site", "site");
//			dc.add(Restrictions.eq("site.id", category.getSite().getId()));
//		}
//		if (category.getParent()!=null && StringUtils2.isNotBlank(category.getParent().getId())){
//			dc.createAlias("parent", "parent");
//			dc.add(Restrictions.eq("parent.id", category.getParent().getId()));
//		}
//		if (StringUtils2.isNotBlank(category.getInMenu()) && Category.SHOW.equals(category.getInMenu())){
...
//		return page;
	...
	public void save(Category category) throws ValidationException {
	...
	@Transactional(readOnly = false)
	public void delete(Category category)throws ValidationException {
