...
public class GenTableColumn extends DataEntity<GenTableColumn> {
	...
	public String getName() {
		return StringUtils2.lowerCase(name);
	}
	...
	public String getJdbcType() {
		return StringUtils2.lowerCase(jdbcType);
	}
	...
	public String getDataLength(){
		String[] ss = StringUtils2.split(StringUtils2.substringBetween(getJdbcType(), "(", ")"), ",");
	...
	public String getSimpleJavaType(){
		if ("This".equals(getJavaType())){
			return StringUtils2.capitalize(genTable.getClassName());
		}
		return StringUtils2.indexOf(getJavaType(), ".") != -1
				? StringUtils2.substringAfterLast(getJavaType(), ".")
						: getJavaType();
	}
	...
	public String getSimpleJavaField(){
		return StringUtils2.substringBefore(getJavaField(), ".");
	}
	...
	public String[][] getJavaFieldAttrs(){
		String[] ss = StringUtils2.split(StringUtils2.substringAfter(getJavaField(), "|"), "|");
		if (null == ss) {
			return null;
		}
		...
		if (ss!=null){
			for (int i=0; i<ss.length; i++){
				sss[i][0] = ss[i];
				sss[i][1] = StringUtils2.toUnderScoreCase(ss[i]);
			}
		}
		return sss;
	}
	...
	public List<String> getSimpleAnnotationList(){
		...
		for (String ann : getAnnotationList()){
			list.add(StringUtils2.substringAfterLast(ann, "."));
		}
		return list;
	}
	...
	public Boolean getIsNotBaseField(){
		return !StringUtils2.equals(getSimpleJavaField(), "id")
				&& !StringUtils2.equals(getSimpleJavaField(), "remarks")
				&& !StringUtils2.equals(getSimpleJavaField(), "createBy")
				&& !StringUtils2.equals(getSimpleJavaField(), "createDate")
				&& !StringUtils2.equals(getSimpleJavaField(), "updateBy")
				&& !StringUtils2.equals(getSimpleJavaField(), "updateDate")
				&& !StringUtils2.equals(getSimpleJavaField(), "delFlag");
	}
