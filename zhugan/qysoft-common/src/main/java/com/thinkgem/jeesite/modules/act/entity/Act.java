...
//	}
	...
	public String getProcDefKey() {
		if (StringUtils2.isBlank(procDefKey) && StringUtils2.isNotBlank(procDefId)){
			procDefKey = StringUtils2.split(procDefId, ":")[0];
		}
		return procDefKey;
	}
	...
	public boolean isFinishTask(){
		return "finish".equals(status) || StringUtils2.isBlank(taskId);
	}
