...
<!-- 头部结束 -->
							...
							<table class="table table_striped align_right">
								...
								<c:forEach items="${page.list}" var="transcodeBuy">
									<tr class="table_crumbs">
										...
										<td  class="align_center">
												${transcodeBuy.num * transcodeBuy.money}
										</td>
										<td  class="align_center">
		...
		<script>
			function page(pageNo,pageSize){
				window.location.href="${ctx}/trans/sells?siteBar=32&pageNo="+pageNo+"&pageSize="+pageSize;
			}
            function look(id){
			    var url = $("#url_"+id).val();
                layer.open({
                    ...
                    '<div id="imgDiv" style="width:100%;height:400px;overflow: hidden;border:1px dashed #ddd;"><img src="'+url+'" style="height:100%;display: block;margin:0 auto;"></div><p style="display:none; width:100%;color:#ff0000;height:30px;line-height:30px;text-align: left;">sss</p>'+
