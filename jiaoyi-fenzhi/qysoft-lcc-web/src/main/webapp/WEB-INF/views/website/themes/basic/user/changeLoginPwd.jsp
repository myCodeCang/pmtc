    ...
    <div class="section doc_section">
        <div class="doc_main_wrap">
            <div class="mod mod_setting">
                <div class="mod_hd">
                    <div class="crumb_nav">
                        <a href="${ctx}/center">设置页面</a> &gt; 重置登录密码
                    </div>
                </div>
                <div class="mod_bd p_all_30">
                    <div class="alert alert_orange m_b_30"> 您正在为账户<span
                            class="font_orange">UID:(${userinfo.userName})${userinfo.trueName}</span>重置登录密码
                    </div>
                    <form action="${ctx}/user/changeLoginPwd" method="post" class="bind_validator" validator="true"
                        ...
                        <div class="group">
                            <div class="col_1  col_text  align_right">确认登录密码</div>
                        ...
                        <div class="group">
                            ...
                            <div class="col_2">
                                <div class="input_m_code" id="input_m_code">
                                    <input name="verfiyCode" id="mobileCode" class="input_text" style="width: 100px" data-type="*" data-msg-null="请输入验证码" type="text">
...
<script type="text/javascript" src="${ctxStatic}/themes/basic/script/setting_bindLoginPasswd.js"></script>
<!-- -->
