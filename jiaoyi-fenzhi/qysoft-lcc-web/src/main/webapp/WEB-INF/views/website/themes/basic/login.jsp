...
<div id="doc_head">
    <div class="head_masthead">
        <div class="section">
            ...
            <h1 class="head_logo"><a href="/" style="width:200px;height:53px;"><img src="${fns:getOption('system_sys','site_logo')}" style="width:200px;height:52px;" alt="交易平台"></a></h1>
    ...
    <div class="section">
        ...
        <form class="form_login bind_validator" id="bind_validator" method="post" action="${ctx}/login" novalidate="novalidate">
            <div class="tab tab01" id="pwdlogin">
                ...
                <p>
                    <input type="text" id="userCode" name="username" class="input_login mail_complete" value="" placeholder="请输入手机号码/会员ID" autocomplete="off">
                </p>
                <div class="relative">
                ...
                <p class="relative" id="vcode_p">
                    ...
                    <input type="text" class="input_login" data-type="*" id="validateCode" name="validateCode" data-msg-null="请输入验证码" placeholder="验证码"> <input type="hidden" name="captcha_key" id="captcha_key" value="">
