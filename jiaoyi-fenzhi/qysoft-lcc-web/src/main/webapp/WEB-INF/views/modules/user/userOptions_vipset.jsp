    ...
    <div class="layui-tab-content">
        ...
        <div class="layui-tab-item layui-show">
            ...
            <form name="inputForm" modelAttribute="optionValue" action="${ctx}/user/userOptions/saveUserSet" method="post" class="form-horizontal layui-form">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea id="register_agreement" name="register_agreement" >${options.system_user_set.register_agreement}</textarea>
                        <sys:ckeditor replace="register_agreement"/>
                        <span class="help-inline"><font color="red">*</font>
								标识:[register_agreement]</span>
                    </div>
                </div>
        ...
        <div class="layui-tab-item layui-show">
            ...
            <form name="bounsForm" modelAttribute="optionValue" action="${ctx}/user/userOptions/saveUserSet" method="post" class="form-horizontal layui-form">
                ...
                <blockquote class="layui-elem-quote">客服一</blockquote>
                <div class="control-group">
                    <label class="control-label">客服昵称：</label>
                    <div class="controls">
                        <input type="text" name="serviceOneName" id="serviceOneName"
                               value="${options.system_static_bonus.serviceOneName}" htmlEscape="false"
                               class="input-xlarge required"/> <span class="help-inline"><font
                            color="red">*</font> 标识:[serviceOneName]</span>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">工作微信：</label>
                    <div class="controls">
                        <input type="text" name="serviceOneWeChat" id="serviceOneWeChat"
                               value="${options.system_static_bonus.serviceOneWeChat}" htmlEscape="false"
                               class="input-xlarge required"/> <span class="help-inline"><font
                            color="red">*</font> 标识:[serviceOneWeChat]</span>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">工作QQ：</label>
                    <div class="controls">
                        <input type="number" name="serviceOneQQ" id="serviceOneQQ"
                               value="${options.system_static_bonus.serviceOneQQ}" htmlEscape="false"
                               class="input-xlarge required"/> <span class="help-inline"><font
                            color="red">*</font> 标识:[serviceOneQQ]</span>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">工作电话：</label>
                    <div class="controls">
                        <input type="number" name="serviceOneMobile" id="serviceOneMobile"
                               value="${options.system_static_bonus.serviceOneMobile}" htmlEscape="false"
                               class="input-xlarge required"/> <span class="help-inline"><font
                            color="red">*</font> 标识:[serviceOneMobile]</span>
                    </div>
                </div>

                <blockquote class="layui-elem-quote">客服二</blockquote>
                <div class="control-group">
                    <label class="control-label">客服昵称：</label>
                    <div class="controls">
                        <input type="text" name="serviceTwoName" id="serviceTwoName"
                               value="${options.system_static_bonus.serviceTwoName}" htmlEscape="false"
                               class="input-xlarge required"/> <span class="help-inline"><font
                            color="red">*</font> 标识:[serviceTwoName]</span>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">工作微信：</label>
                    <div class="controls">
                        <input type="text" name="serviceTwoWeChat" id="serviceTwoWeChat"
                               value="${options.system_static_bonus.serviceTwoWeChat}" htmlEscape="false"
                               class="input-xlarge required"/> <span class="help-inline"><font
                            color="red">*</font> 标识:[serviceTwoWeChat]</span>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">工作QQ：</label>
                    <div class="controls">
                        <input type="number" name="serviceTwoQQ" id="serviceTwoQQ"
                               value="${options.system_static_bonus.serviceTwoQQ}" htmlEscape="false"
                               class="input-xlarge required"/> <span class="help-inline"><font
                            color="red">*</font> 标识:[serviceTwoQQ]</span>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">工作电话：</label>
                    <div class="controls">
                        <input type="number" name="serviceTwoMobile" id="serviceTwoMobile"
                               value="${options.system_static_bonus.serviceTwoMobile}" htmlEscape="false"
                               class="input-xlarge required"/> <span class="help-inline"><font
                            color="red">*</font> 标识:[serviceTwoMobile]</span>
                    </div>
                </div>


                <blockquote class="layui-elem-quote">工作时间</blockquote>
                <div class="layui-field-box">
                    <div class="control-group">
                        <label class="control-label">上午开始时间：</label>
                        <div class="controls">
                            <input name="morning_service_time_begin" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
                                   value="${options.system_static_bonus.morning_service_time_begin}"
                                   onclick="WdatePicker({dateFmt:' HH:mm:ss',isShowClear:false});"/>
                            <span class="help-inline"><font
                                    color="red">*</font> 标识:[morning_service_time_begin] </span>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">上午结束时间：</label>
                        <div class="controls">
                            <input name="morning_service_time_end" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
                                   value="${options.system_static_bonus.morning_service_time_end}"
                                   onclick="WdatePicker({dateFmt:' HH:mm:ss',isShowClear:false});"/>
                            <span class="help-inline"><font
                                    color="red">*</font> 标识:[morning_service_time_end] </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="layui-field-box">
                    <div class="control-group">
                        <label class="control-label">下午开始时间：</label>
                        <div class="controls">
                            <input name="afternoon_service_time_begin" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
                                   value="${options.system_static_bonus.afternoon_service_time_begin}"
                                   onclick="WdatePicker({dateFmt:' HH:mm:ss',isShowClear:false});"/>
                            <span class="help-inline"><font
                                    color="red">*</font> 标识:[afternoon_service_time_begin] </span>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">下午结束时间：</label>
                        <div class="controls">
                            <input name="afternoon_service_time_end" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
                                   value="${options.system_static_bonus.afternoon_service_time_end}"
                                   onclick="WdatePicker({dateFmt:' HH:mm:ss',isShowClear:false});"/>
                            <span class="help-inline"><font
                                    color="red">*</font> 标识:[afternoon_service_time_end] </span>
                        </div>
                    </div>
                </div>
        ...
        <div class="layui-tab-item layui-show">
            ...
            <form name="bounsForm" modelAttribute="optionValue" action="${ctx}/user/userOptions/saveUserSet" method="post" class="form-horizontal layui-form">
                <input type="hidden" name="optName" value="system_static_bonus"/>
                <blockquote class="layui-elem-quote">客服配置</blockquote>
