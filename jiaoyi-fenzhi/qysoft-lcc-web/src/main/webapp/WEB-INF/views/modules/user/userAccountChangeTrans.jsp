...
<body>
	...
	<form:form id="searchForm" modelAttribute="userAccountchange" action="${ctx}/user/hclmReport/accountTrans" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li><label>账变类型</label>
				<select id="changeType" name="changeType">
					...
					<option value="77" ${userAccountchange.changeType == '77'?"selected":""} >交易钱包转出</option>
					<option value="209" ${userAccountchange.changeType == '209'?"selected":""} >交易钱包转入</option>
				</select>
			</li>
