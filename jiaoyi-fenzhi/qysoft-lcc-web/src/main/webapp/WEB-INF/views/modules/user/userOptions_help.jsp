    ...
    <div class="layui-tab-content">
        ...
        <div class="layui-tab-item layui-show">
            ...
            <form name="inputForm" modelAttribute="optionValue"
                ...
                <div class="control-group">
                    <label class="control-label" id="lable">是否发直推奖励：</label>
                    <div class="controls">
                ...
                <div class="control-group">
                    <label class="control-label">转账手续费配置：</label>
                    <div class="controls">
                ...
                <div class="control-group">
                    <label class="control-label">激活最低转账额度配置：</label>
                    <div class="controls">
                        <input type="number" name="active_money"
                               value="${options.system_help.active_money }" htmlEscape="false"
                               class="input-xlarge required"/>
                        <span class="help-inline"><font
                                color="red">*</font> 标识:[active_money] </span>
                    </div>
                </div>
                ...
                <div class="control-group">
                    <label class="control-label">矿机钱每日转入总钱包比例配置：</label>
                    <div class="controls">
                ...
                <div class="control-group">
                    <label class="control-label">总钱包互转金额倍数配置：</label>
                    <div class="controls">
                ...
                <div class="control-group">
                    <label class="control-label">团队奖计算层数:</label>
                    <div class="controls">
                ...
                <div class="control-group">
                    <label class="control-label">团队等级持币数限制:</label>
                    <div class="controls">
                ...
                <div class="control-group">
                    <label class="control-label">团队等级直推人数限制:</label>
                    <div class="controls">
                ...
                <%--<div class="control-group">--%>
                    <%--<label class="control-label">每天会员转账额度为矿机钱包余额的倍数配置：</label>--%>
                    <%--<div class="controls">--%>
