    ...
    <div class="layui-tab-content">
        ...
        <div class="layui-tab-item">
            <form name="lkSmsForm" modelAttribute="optionValue"
                ...
                <blockquote class="layui-elem-quote">凌凯短信设置[国内]</blockquote>
                <div class="control-group">
                    <label class="control-label">短信接口地址：</label>
                    <div class="controls">
                        <input type="text" name="lk_address" id="lk_address"  
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="lk_acc" id="lk_acc"  
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="password" name="lk_pwd" id="lk_pwd"  
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="lk_msg_template" id="lk_msg_template"  
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="lk_msg_registe" id="lk_msg_registe"  
                ...
                <blockquote class="layui-elem-quote">凌凯短信设置[国际]</blockquote>
                <div class="control-group">
                    <label class="control-label">短信接口地址：</label>
                    <div class="controls">
                        <input type="text" name="lk2_address" id="lk2_address"
                               value="${options.system_sms.lk2_address}" htmlEscape="false"
                               maxlength="64" class="input-xlarge required"/> <span
                            class="help-inline"><font color="red">*</font>
								标识:[lk2_address]</span>
                    </div>
                ...
                <div class="control-group">
                    <label class="control-label">账号：</label>
                    <div class="controls">
                        <input type="text" name="lk2_acc" id="lk2_acc"
                               value="${options.system_sms.lk2_acc}" htmlEscape="false"
                               maxlength="64" class="input-xlarge required"/> <span
                            class="help-inline"><font color="red">*</font>
								标识:[lk2_acc]</span>
                    </div>
                ...
                <div class="control-group">
                    <label class="control-label">密码：</label>
                    <div class="controls">
                        <input type="password" name="lk2_pwd" id="lk2_pwd"
                               value="${options.system_sms.lk2_pwd }" htmlEscape="false"
                               class="input-xlarge required"/> <span class="help-inline"><font
                            color="red">*</font> 标识:[lk2_pwd]</span>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">验证码消息模板：</label>
                    <div class="controls">
                        <input type="text" name="lk2_msg_template" id="lk2_msg_template"
                               value="${options.system_sms.lk2_msg_template }" htmlEscape="false"
                               class="input-xlarge required"/> <span class="help-inline"><font
                            color="red">*</font> 标识:[lk2_msg_template]</span>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">注册成功消息模板：</label>
                    <div class="controls">
                        <input type="text" name="lk2_msg_registe" id="lk2_msg_registe"
                               value="${options.system_sms.lk2_msg_registe }" htmlEscape="false"
                               class="input-xlarge required"/> <span class="help-inline"><font
                            color="red">*</font> 标识:[lk2_msg_registe]</span>
                    </div>
                </div>
