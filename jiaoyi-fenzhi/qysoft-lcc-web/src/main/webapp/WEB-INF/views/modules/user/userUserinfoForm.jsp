...
<body>
	...
	<form:form id="inputForm" modelAttribute="userUserinfo" action="${ctx}/user/userUserinfo/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">交易钱包地址：</label>
			<div class="controls">
				<form:input path="remarks" htmlEscape="false" maxlength="50" class="input-xlarge " readonly="true" />
				<span class="help-inline"><font color="red"></font></span>
			</div>
		</div>
		<c:if test="${userUserinfo.usercenterAddress != '0'}">
		<div class="control-group">
			<label class="control-label">会员钱包地址：</label>
			<div class="controls">
				<form:input path="usercenterAddress" htmlEscape="false" maxlength="50" class="input-xlarge " readonly="true" />
				<span class="help-inline"><font color="red"></font></span>
			</div>
		</div>
		</c:if>
