...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/user/userLevel/">团队等级列表</a></li>
		<li class="active"><a href="${ctx}/user/userLevel/form?id=${userLevel.id}">团队等级<shiro:hasPermission name="user:userLevel:edit">${not empty userLevel.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="user:userLevel:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="userLevel" action="${ctx}/user/userLevel/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">等级所需业绩(单位:万)：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">业绩比例(单位:‰)：</label>
			<div class="controls">
